...
// Code generated by C:\Users\loren\go\bin\conversion-gen.exe. DO NOT EDIT.
...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*LatencyAwareArgs)(nil), (*config.LatencyAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_LatencyAwareArgs_To_config_LatencyAwareArgs(a.(*LatencyAwareArgs), b.(*config.LatencyAwareArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.LatencyAwareArgs)(nil), (*LatencyAwareArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_LatencyAwareArgs_To_v1_LatencyAwareArgs(a.(*config.LatencyAwareArgs), b.(*LatencyAwareArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_LatencyAwareArgs_To_config_LatencyAwareArgs(in *LatencyAwareArgs, out *config.LatencyAwareArgs, s conversion.Scope) error {
	if err := metav1.Convert_Pointer_string_To_string(&in.ProbeAppLabel, &out.ProbeAppLabel, s); err != nil {
		return err
	}
...
// Convert_v1_LatencyAwareArgs_To_config_LatencyAwareArgs is an autogenerated conversion function.
func Convert_v1_LatencyAwareArgs_To_config_LatencyAwareArgs(in *LatencyAwareArgs, out *config.LatencyAwareArgs, s conversion.Scope) error {
	return autoConvert_v1_LatencyAwareArgs_To_config_LatencyAwareArgs(in, out, s)
}

func autoConvert_config_LatencyAwareArgs_To_v1_LatencyAwareArgs(in *config.LatencyAwareArgs, out *LatencyAwareArgs, s conversion.Scope) error {
	if err := metav1.Convert_string_To_Pointer_string(&in.ProbeAppLabel, &out.ProbeAppLabel, s); err != nil {
		return err
	}
...
// Convert_config_LatencyAwareArgs_To_v1_LatencyAwareArgs is an autogenerated conversion function.
func Convert_config_LatencyAwareArgs_To_v1_LatencyAwareArgs(in *config.LatencyAwareArgs, out *LatencyAwareArgs, s conversion.Scope) error {
	return autoConvert_config_LatencyAwareArgs_To_v1_LatencyAwareArgs(in, out, s)
}
