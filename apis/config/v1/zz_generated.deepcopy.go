...
// Code generated by C:\Users\loren\go\bin\deepcopy-gen.exe. DO NOT EDIT.
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LatencyAwareArgs) DeepCopyInto(out *LatencyAwareArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.ProbeAppLabel != nil {
		in, out := &in.ProbeAppLabel, &out.ProbeAppLabel
		*out = new(string)
		**out = **in
	}
	if in.TargetAppLabel != nil {
		in, out := &in.TargetAppLabel, &out.TargetAppLabel
		*out = new(string)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LatencyAwareArgs.
func (in *LatencyAwareArgs) DeepCopy() *LatencyAwareArgs {
	if in == nil {
		return nil
	}
	out := new(LatencyAwareArgs)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *LatencyAwareArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
